...
//Encode 8 bytes
void BlowFish::Blowfish_encipher(TUint32 *xl,
                                 TUint32 *xr)
    {
    union aword Xl;
    union aword Xr;
...
//Decode 8 bytes
void BlowFish::Blowfish_decipher(TUint32 *xl, TUint32 *xr)
    {
    union aword Xl;
    union aword Xr;
...
//Wrapping Encrypt algo not needed with CFB
/*void BlowFish::Encrypt(block in, block out)
    {
    for (int x=0; x<8; x++)
        out[x] = in[x];

    Blowfish_encipher((TUint32*)out,
                      (TUint32*)(out+sizeof(TUint32)));
    }*/


//Wrapping Decrypt algo not needed with CFB
/*void BlowFish::Decrypt(block in, block out)
    {
    for (int x=0; x<8; x++)
        out[x] = in[x];
    Blowfish_decipher((TUint32*)out,
                      (TUint32*)(out+sizeof(TUint32)));
    }*/
//-----------------------------------------------------------------------------
//-----------------------------------------------------------------------------
